package org.wandukong.app.users
...
import org.wandukong.app.util.ItemTouchCallback
...
import org.wandukong.app.users.data.UserData
                ...
                response.takeIf { it.isSuccessful }
                        ...
                        ?.let { loadUsersData ->
                            for (i in 0 until loadUsersData.data.size){
                                userList.add(
                                    UserData(loadUsersData.data[i].first_name + " " + loadUsersData.data[i].last_name,
